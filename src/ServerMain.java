...
public class ServerMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            pool.execute(new RewardCalculator(customServer.getRewardRate(),
                    customServer.getStorageService(),
                    customServer.getAuthorPercentage(),
                    customServer.getMulticastAddress(),
                    customServer.getMulticastPort()));
